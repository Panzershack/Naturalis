window.addEventListener('DOMContentLoaded', () => {
  ...
  const orders = [
    { username: 'John Doe', address: '123 Main St', telephone: '555-1234', paymentMethod: 'Credit Card' },
    { username: 'Jane Smith', address: '456 Elm St', telephone: '555-5678', paymentMethod: 'PayPal' },
  ];
